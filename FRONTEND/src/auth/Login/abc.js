...
export const ReactFinalFormDemo = () => {
    ...
    return (
        <div className="form-demo">
            <Dialog visible={false} onHide={() => true} position="top" footer={dialogFooter} showHeader={false} breakpoints={{ '960px': '80vw' }} style={{ width: '30vw' }}>
                ...
                <div className="card">
                    ...
                    <form onSubmit={onSubmit} initialValues={{ name: '', email: '', password: '', date: null, country: null, accept: false }} validate={validate} render={({ handleSubmit }) => (
                        <form onSubmit={handleSubmit} className="p-fluid">
                            <div name="name" render={({ input, meta }) => (
                                <div className="field">
